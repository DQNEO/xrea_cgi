...
for my $i(0..14) {
	...
	$tr[$i] = "<tr><td>".substr($data[2],5)."</td><td>$shushin</td><td><b>$kisho{$data[2]}</b></td><td>$sleep</td><td>$data[6]</td>";
...
<html>
<head><title>$userのすいみん記録</title>
<style type="text/css">
 .weekend { background:pink; }
</style>
</head>
<body><center>
<h2 style='color:blue;'>すいみん記録</h2>
...
print "<table><tr><td>日付</td><td>就寝</td><td><b>起床</b></td><td>睡眠</td><td>メモ</td></tr>\n";
foreach (@tr) {
	print;
}
print "</table>\n";
